...
<div class="actions mt-2">
  <div class="row">
    ...
    <div class="col-md-3">
      <a href="{{url('/goods/create')}}" class="btn btn-primary pull-right mb-3" title="Создать новый элемент">
      ...
      <tr>
        ...
        <td class="text-right">
          ...
          <form onsubmit="if(confirm('Удалить?')) {return true} else {return false}" 
                action="{{url('/goods/'.$good->id)}}" method="POST">
            {{ method_field('delete')}}
            {{ csrf_field()}}
            <a href="{{url('/goods/'.$good->id.'/edit')}}" class="btn btn-sm btn-success" title="Редактировать"><i class="fa fa-edit"></i></a>
